...
export const RainIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15h5.25a3.75 3.75 0 003.75-3.75V11.25a3.75 3.75 0 00-3.75-3.75h-2.338a4.5 4.5 0 00-4.362-3.438zM14.25 12.75l-2.25 2.25-2.25-2.25" />
        <path d="M10 18.5l.5 1 .5-1m2.5-2l.5 1 .5-1" />
    </svg>
);

export const SnowIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 5.25v13.5m-3.375-3.375L12 18.75l3.375-3.375M12 5.25L8.625 8.625 12 12l3.375-3.375L12 5.25zM5.625 8.625h12.75" />
    </svg>
);

export const ThermometerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6.262v10.675a3 3 0 01-3 2.863 3 3 0 01-3-2.863V6.262a3 3 0 116 0z" />
  </svg>
);
...
export const HumidityIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.75 9.75 0 007.03-16.944A9.75 9.75 0 1012 21zM12 8.25v4.5a.75.75 0 001.5 0V9a.75.75 0 00-.75-.75h-3a.75.75 0 000 1.5h1.5z" />
  </svg>
);
